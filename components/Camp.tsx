...
const Camp = () => {
  return (
    <section className="relative 2xl:max-container
    flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      ...
      <div className="mt-10 px-6 flexEnd lg:-mt-60 lg:mr-6">
        <div className="bg-green-50 p-8 w-full lg:max-w-[500px] xl:max-w-[734px]
        xl:rounded-5xl xl:py-20 xl:px-16 relative rounded-3xl overflow-hidden">
          <h2 className="regular-24 capitalize text-white md:regular-32 2xl:regular-64">
            <strong>Feeling Lost</strong> And Not Knowing The Way?
          </h2>
          <p className="regular-14 mt-5 text-white lg:regular-16">
