    ...
    <section className="flex-Center flex-col">
      <div className="padding-container max-container w-full pb-24">
        <Image
          ...
          height={50}
        />
        <p className="regular-18 -mt-1 mb-3 text-green-50 uppercase">
          We are here for you
        </p>
      ...
      <div className="flexCenter max-container relative w-full">
        ...
        <div className="absolute flex bg-white py-8 pl-5 pr-7 gap-3 border
        shadow-md rounded-3xl md:left-[5%] lg:top-20">
          <Image
            src="/meter.svg"
            alt="meter"
            width={16}
